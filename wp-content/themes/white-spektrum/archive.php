...
<?php get_header(); ?>
    <div id="main-content" class="content-area">
        <?php if (have_posts()) : ?>
			...
			<?php 
				if (is_category()) {
					printf(__('Category: ','white-spektrum'));
					echo single_cat_title(); 
				} elseif (is_tag()) {
					printf(__('Tag: ', 'white-spektrum'));
					echo single_tag_title(); 
				} elseif (is_author()) {
					printf(__('Author Archives: ', 'white-spektrum'));
					echo get_the_author(); 
				} elseif (is_day()) {
					printf(__('Daily Archives: ', 'white-spektrum'));
					echo get_the_date();
				} elseif (is_month()) {
					printf(__('Monthly Archives: ', 'white-spektrum'));
					echo get_the_date('F Y');
				} elseif (is_year()) {
					printf(__('Yearly Archives: ', 'white-spektrum'));
					echo get_the_date('Y');
				}else {
					echo 'Archives: ';
				}
